...
const EmailVerificationPage = () => {
  ...
  const handleChange = (index, value) => {
    ...
    if (value.length > 1) {
      ...
      //Move focus onto next input field if value is entered
      if (value && index < 5) {
  ...
  //Auto submit when all input fields are filled
  useEffect(() => {
  ...
  return (
    ...
    >
      <motion.div
        ...
        className="max-w-md w-full p-8 bg-gray-800 bg-opacity-50 backdrop-filter 
